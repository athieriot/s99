package Problem83Solution

// Problem83Solution (**) Construct all spanning trees.
...
class Graph[T, U] extends GraphBase[T, U] {
  // edgeConnectsToGraph is needed for Problem84Solution, so it's not an internal function.
