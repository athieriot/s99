package Problem36Solution

// Problem36Solution (**) Determine the prime factors of a given positive integer (2).
...
/*
// One approach is to reuse the solution from Problem10Solution.
