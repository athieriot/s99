package Problem84Solution

// Problem84Solution (**) Construct the minimal spanning tree.
...
//     modification of the solution of Problem83Solution does the trick.  The data of the
