package Problem68Solution

// Problem68Solution (**) Preorder and inorder sequences of binary trees.
//     We consider binary trees with nodes that are identified by single
//     lower-case letters, as in the example of problem Problem67Solution.
//
...
//        preorder sequence of the example in problem Problem67Solution.
//
