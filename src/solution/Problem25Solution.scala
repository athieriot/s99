package Problem25Solution

// Problem25Solution (*) Generate a random permutation of the elements of a list.
//     Hint: Use the solution of problem Problem23Solution.
//
//     Example:
//     scala> randomPermute(List('a, 'b, 'c, 'd, 'e, 'f))
//     res0: List[Symbol] = List('b, 'a, 'd, 'c, 'e, 'f)

object Problem25Solution {
