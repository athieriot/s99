package Problem47Solution

// Problem47Solution (*) Truth tables for logical expressions (2).
//     Continue problem Problem46Solution by redefining and, or, etc as operators.  (i.e. make
