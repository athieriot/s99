package Problem27Solution

// Problem27Solution (**) Group the elements of a set into disjoint subsets.
...
object Problem27Solution {
  import Problem26Solution.Problem26Solution.combinations
