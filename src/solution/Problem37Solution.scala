package Problem37Solution

// Problem37Solution (**) Calculate Euler's totient function phi(m) (improved).
//     See problem Problem34Solution for the definition of Euler's totient function.  If the
//     list of the prime factors of a number m is known in the form of problem
//     Problem36Solution then the function phi(m>) can be efficiently calculated as follows:
